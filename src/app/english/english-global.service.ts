...
export class EnglishGlobalService {
  ...
  <ion-col class="ion-text-center" style="color:maroon;">
    ...
    So, elders by their wisdom, during that time, as an honour and respect, used to call him as ॑Ten headed' or Dasa Kanta. That did not mean that he was having ten heads, physically. But from one aspect, Dasa headed is correct with regard to his magnificent 1Q and he was having one head only. 
    <br><br>
...
<br><br>
6. Reveal to all that in the word, "DRAVIDA", signifies "Doctrine of Three Souls", i.e.. Thraitha Siddhantha Theorem', and that the three letters-(DRA), (VI), (DA) represent three Souls- "Paramatma, Atma and Jeevatma“ respectively. 
<br><br>
